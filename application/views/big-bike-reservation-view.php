...
<head>
  ...
  <title>Big Bike Reservation Form | Motortrade Group</title>
...
<body>
      ...
      <div class="row px-5" id="sub-wrapper">
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="card" style="opacity: .85;">
            <!-- Start Form -->
            <form action="" id="bigbike-reservation-form" name="bigbike-reservation-form" method="POST" enctype="multipart/form-data" data-formstate="0" data-otptries="3" data-otpstate="0" data-otp-exp-min="5">

              <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
              <div class="card-header">
                <h3 class="mb-0">Big Bike Reservation Form</h3>
              </div>
              ...
              <div class="card-body" id="mainformbody">
                ...
                <!-- Big Bike Details -->
                <h5 class="card-title">Big Bike Reservation Details</h5>


                <div class="row">
                  <div class="form-group col-lg-4">
                    <label for="category">Category</label>
                    <select class="form-control required-field custom-select" id="category" name="category" style="width:100% !important" required>
                  ...
                  <!-- Preffered MC Brand -->
                  <div class="form-group col-lg-4">
                    <label for="bigbike">Preferred MC Unit </label>
                    <select class="form-control required-field use-select2" id="bigbike" name="bigbike" required>

                    </select>
                    <input type="hidden" name="brand_id" id="brand_id">
                  </div>
                  <div class="form-group col-lg-4">
                    <label for="color">MC Color</label>
                    <select class="form-control required-field custom-select" name="color" id="color">
                      <option value="" class="text-white bg-warning">
                        -Select-
                      </option>
                      <?php
                  ...
                  <div class="form-group col-lg-6 col-sm-12">
                    <label for="branch_code">Preferred Branch Address</label>
              ...
              <div class="card-footre text-center">
                <div class="row">
                  <div class="form-group col-md-12 col-lg-12">
                    <button type="submit" class="btn btn-md btn-primary" name="btn_bigbike_form" id="btn_bigbike_form">Submit Form
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:1rem 2rem !important">
          ...
          <div class="form-group col-lg-12">
            <button type="button" class="btn btn-primary form-control" id="btn-confirmotp-bigbike">Continue</button>
          </div>
  ...
  <script src="<?= base_url(); ?>assets/js/bigbike.js?v=<?= rand(); ?>"></script>
  <script src="<?= base_url(); ?>assets/js/common.js?2"></script>
  <!-- END RUSSEL -->
  <script>
    filledInSelectElem($("#bigbike"), bigbike, null, isBrandId = true);
  </script>
  <script>
