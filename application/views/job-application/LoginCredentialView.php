...
<body>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form id="login-form" method="post" enctype="multipart/form-data" action=""  data-formstate="0" data-otptries="3" data-otpstate="0" data-otp-exp-min="5">

                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            <i class="fas fa-pencil fa-2x me-3" style="color: #ff6219;"></i>
                                            <span class="h1 fw-bold mb-0">Online Exam</span>
                                        </div>
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Sign in </h5>
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <input type="email" id="app_email" name="email" class="form-control form-control-lg" />
                                            <label class="form-label" for="app_email">Applicant Email</label>
                                        </div>
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <input type="text" id="app_id" name="applicant_id" class="form-control form-control-lg" />
                                            <label class="form-label" for="app_id">Applicant ID</label>
                                        </div>
                                        <!-- <div class="pt-1 mb-4"> -->
    ...
    <script src="./assets/JobApp/js/login.js?refresh=<?= date('YmdHis') ?>"></script>
</body>
