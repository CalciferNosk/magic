    ...
    <div class="row">
        <div class="col-md-6">
            <div class="error-template">
                <h1>
                    <i class="fa fa-fw fa-frown-o"></i> Oops!</h1>
                <h2>
                ...
                <div>
                    ...
                    <p>
                    For Loan Application, Please contact your nearest Motortrade Branch. 
                    </p>
                    <p>
                        Thank you and keep safe Ka-Moto!</p>
                </div>
                <div class="error-actions">
                    <a href="https://cportal.motortrade.com.ph/" style="margin-top: 10px;" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home">
                    </span> Take Me Home </a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <img src="<?= base_url(); ?>assets/images/userpic.png" alt="Motortrade 50 years" class="img-responsive" style="width: 55%; border-radius: 10%; margin-top: 2%;">
